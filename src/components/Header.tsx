    ...
    <>
      <div className="sticky top-0 z-40 bg-[#0a0a0a]/80 backdrop-blur supports-[backdrop-filter]:bg-[#0a0a0a]/60">
        <div className="h-14 px-3 sm:px-4">
          <div className="max-w-[1440px] mx-auto h-14 flex items-center gap-2 sm:gap-4">
            {/* 左侧区域 - 汉堡菜单 */}
                ...
                <div className="w-full max-w-md">
                  <div className="relative">
                    ...
                    <button 
                      ...
                      className="custom-size absolute right-0.5 sm:right-1.5 top-1/2 -translate-y-1/2 px-3 sm:px-4 h-6 sm:h-8 rounded-3xl bg-blue-600 text-white text-xs sm:text-sm font-medium hover:bg-blue-300 transition-colors flex-shrink-0"
                    >
                      搜 索
                    </button>
                  </div>
